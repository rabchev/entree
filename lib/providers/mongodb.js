...
MongoCursor.prototype.update = function (data, callback) {
    var opts = _.clone(this.provider.options.update);
    opts.multi = true;
    this.provider.collection.update(this.query, data, opts, callback);
};

MongoCursor.prototype.delete = function (callback) {
    var opts = _.clone(this.provider.options.delete);
    opts.single = false;
    this.provider.collection.remove(this.query, opts, callback);
};
