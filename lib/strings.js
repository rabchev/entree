...
var strings = {
    ...
    "TRANS_NOT_INITIAL"         : "A transaction can be saved only when in initial state.",
    "INVALID_FIELD_NAME"        : "Field names cannot start with $.",
    "OPERS_ONLY_ALLOWED"        : "Only update operators, such as $set and $inc, are allowed in batch updates.",
    "OPERS_NOT_ALLOWED"         : "Update operators, such as $set and $inc, are not allowed when inserting. However, they can be used with upsert method.",
    "COLLECTIVE_ERROR"          : "Multiple errors have occurred. To see them, please examine \"errors\" collection.",
    "CANNOT_INC_VERSION"        : "Cannot increment version when replacing the entire document.",
    "INVALID_TRANS_STORE"       : "Invalid configuration for transaction store."
};
