 ...
 *
 * Execution context is used to pass arguments to interceptors. For instance, authorization interceptor will require an `user` object in the context to determine the rights of the caller for the current operation.
 *
