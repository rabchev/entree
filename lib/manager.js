...
function FluentContext(parent, manager, name) {
    this.parent = parent;
...
FluentContext.prototype = {
    ...
    addCollection: function (name) {
        return new FluentContext(this, this.manager, name);
    },
        ...
        var fns     = [],
            ...
            fn      = function (ctx) {
                return function (cb) {
                    setProvider(ctx.manager, ctx.name, ctx.connection, ctx.interceptors, ctx.schema, cb);
                };
            };
...
Manager.prototype.addCollection = function (name, connection, interceptors, schema, done) {
    ...
    if (arguments.length === 1) {
        return new FluentContext(null, this, name);
    }
    ...
    setProvider(this, name, connection, interceptors, schema, done);
    return this;
};
