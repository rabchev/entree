...
/**
 * Closes all opened database connections and clears current state and all cached data if any.
 ...
 *      ];
 *
 *  entree.addCollection("users");
 *  entree.users.use(cache.interception(stores, ["get", "select"]));
 *
 * @func
