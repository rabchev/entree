 ...
 *      .update({$set: { age: 555 }});
 *
 * @data {object} data - An object containing the fields and values to update.
 * @param {function} callback - Will be called after executing this method. The first parameter will contain an error object on error. The second parameter may defer for the different providers, e. g. file-system returns an array of all updated items while mongodb will return the number of updated items.
 * @return {null}
 * @api public
 */
